    ...
    return (
        <>
            ...
            <div className="page-wrapper">
                <div className="page-breadcrumb">
                    <div className="row align-items-center">
                        ...
                        <div className="col-6">
                            <div className="text-end upgrade-btn d-flex justify-content-end">
                                ...
                                <ReactToPrint 
                                    trigger={() => (
                                        <div className="text-end upgrade-btn mx-3">
            ...
            <div className="print-template">
                <TablePrintTemplate 
                    ref={element => printTemplateRef = element}
                    title={title}
